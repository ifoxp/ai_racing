...
# Непарна кількість — гарантує промінь точно на 0° (прямо вперед). З парною
# кількістю (np.linspace(-90, 90, 8)) найближчі промені опинялись на ±12.9°,
# і бот не мав прямого виміру відстані до перешкоди по курсу руху — саме
# туди, куди найчастіше в'їжджав на швидкості.
RAY_ANGLES_DEG = np.linspace(-90, 90, RAY_COUNT)  # відносно heading машини, віялом вперед/убік
