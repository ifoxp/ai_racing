...
# густіше по центру (0°, ±5°), де потрібна точність для прямої траєкторії на
# швидкості, рідше до країв (±35°, ±60°, ±90°), де досить грубо знати "стіна
# десь там". Непарна кількість у центрі гарантує промінь точно на 0°.
_FRONT_SIDE_ANGLES_DEG = [-90, -60, -35, -5, 0, 5, 35, 60, 90]
